		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comvinaypracticesconsumenodejsapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comvinaypracticesconsumenodejsapp-display": {
								"semanticObject": "comvinaypracticesconsumenodejsapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.vinay.practices.consumenodejsapp",
									"url": sap.ui.require.toUrl("com/vinay/practices/consumenodejsapp")
								}
							}
						}
					}

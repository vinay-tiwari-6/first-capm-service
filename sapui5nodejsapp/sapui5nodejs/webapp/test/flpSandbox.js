		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comvinaypracticessapui5nodejs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comvinaypracticessapui5nodejs-display": {
								"semanticObject": "comvinaypracticessapui5nodejs",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.vinay.practices.sapui5nodejs",
									"url": sap.ui.require.toUrl("com/vinay/practices/sapui5nodejs")
								}
							}
						}
					}
